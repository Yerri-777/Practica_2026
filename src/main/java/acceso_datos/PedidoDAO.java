...
public class PedidoDAO {
    ...
    public int guardar(Pedido pedido) throws SQLException, ClassNotFoundException {
    ...
    public void actualizarEstado(int idPedido, String nuevoEstado) throws SQLException, ClassNotFoundException {
